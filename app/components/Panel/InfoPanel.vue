  ...
  <div>
    ...
    >
      ...
      >
        ...
        <button
          class="text-gray-500 hover:text-gray-700 font-bold transform transition-transform duration-300 p-1"
      ...
      <article 
        v-show="isPanelOpen"
        class="panel-body p-4 pt-2 flex-1 overflow-y-auto overscroll-contain"
      >
        <PanelTabSelector />
